...
if(isset($_POST['submit'])) {
    ...
    if(!$firstname) {
        ...
        if($createpassword !== $confirmpassword) {
            ...
            $user_check_query = "SELECT * FROM ussers WHERE username='$username' OR email='$email'";
            ...
            if(mysqli_num_rows($user_check_result) > 0) {
                ...
                if(in_array($extention, $allowed_files)) {
                    ...
                    if($avatar['size'] < 1000000) {
                        ...
                        $_SESSION['signup'] = "File is too big. Shold be less then 1mb";
                    } 
                } else {
    ...
    //redirect back to signin page if there was any problem
    if(isset($_SESSION['signup'])) {
        ...
        $insert_user_query = "INSERT INTO ussers SET 
        firstname='$firstname',
        lastname='$lastname',
        username='$username',
        email='$email',
