...
<?php if (mysqli_num_rows($featured_result) == 1) : ?>    
    <section class="featured">
      <div class="container post featured__container">
        <div class="post__thumbail">
          <img src="./images/<?= $featured['thumbnail'] ?>" alt="blog-img" />
        </div>
        <div class="post__info">
          ...
          <div class="post__author">
            ...
            $author_query = "SELECT * FROM ussers WHERE id=$author_id";
...
<?php endif ?>
    ...
    <section class="posts <?= $featured ? '' : 'section-extra-margin' ?>">
      <div class="container posts__container">
        ...
        <article class="post">
          <div class="post__thumbail">
            <img src="./images/<?= $post['thumbnail'] ?>" alt="img" />
          </div>
          <div class="post__info">
          <?php
          // fetch category from categories table using category_id of post
